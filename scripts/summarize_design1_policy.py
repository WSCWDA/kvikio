        ...
        rows.append(
            {
                ...
                "kvikio_threshold_bytes": data.get("kvikio_threshold_bytes", 0),
                "profiling_bypassed": data.get("profiling_bypassed", False),
                "groute_enabled": data.get("groute_enabled", True),
                "runtime_kvikio_path": data.get("runtime_kvikio_path", ""),
        ...
        summary.append(
            {
                ...
                "kvikio_threshold_bytes": first["kvikio_threshold_bytes"],
                "profiling_bypassed": first["profiling_bypassed"],
                "groute_enabled": first["groute_enabled"],
                "runtime_kvikio_path": first["runtime_kvikio_path"],
                "runs": len(group),
