        ...
        rows.append(
            {
                ...
                "cache_lookup_wait_ns": cache.get("lookup_wait_ns", 0),
                "cache_lookup_ns": cache.get("lookup_ns", 0),
                "cache_storage_read_ns": cache.get("storage_read_ns", 0),
                "cache_copy_submit_ns": cache.get("copy_submit_ns", 0),
                "cache_completion_wait_ns": cache.get("completion_wait_ns", 0),
                "cache_copy_completions": cache.get("copy_completions", 0),
                "cache_batch_calls": cache.get("batch_calls", 0),
                "cache_batch_reads": cache.get("batch_cache_reads", 0),
                "cache_pinned_bypasses": cache.get("pinned_bypasses", 0),
